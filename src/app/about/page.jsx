      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
            Hey there! My name is Roshan Shamas, and I am a full-stack developer with over 5 years of experience working in various companies and startups. My main focus is on creating full-stack web applications using Next.js and TypeScript.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
            Code is not just a set of instructions for a machine; it's a bridge that connects ideas with reality, transforming abstract concepts into tangible solutions that can change the world.
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    I mainly contributed to the Company Frontend and Backend Both using Next.js and Typescript
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I Mainly contributed to the companyy Frontend Using Next.js and TailwindCSS 
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2019 - 2021{" "}
